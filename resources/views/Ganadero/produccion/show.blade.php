...
<div class="max-w-3xl mx-auto space-y-6">
  ...
  <div class="rounded-2xl border border-gray-200 bg-white shadow-sm p-6">
    <div class="flex items-center space-x-3 mb-4">
      ...
      <h2 class="text-2xl font-bold text-gray-800"> Vaca #{{ $produccion->id_vaca }}</h2>
    </div>

    <div class="text-gray-700 space-y-2 text-base">

      <p><strong>Tipo:</strong> {{ $produccion->tipo }}</p>
    ...
    <div class="mt-6 flex justify-end space-x-3">
      ...
      <a href="{{ route('Ganadero.produccion.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition">Volver</a>
      @endif
